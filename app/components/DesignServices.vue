...
<template>
    <section
        class="fixed inset-0 z-40 flex flex-col overflow-y-auto bg-stone-200 py-32 transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform"
        :class="active
            ? 'translate-y-0'
            : 'translate-y-full'"
    >
